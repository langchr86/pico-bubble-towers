...
function CreatePredefinedWaveList(level)
  ...
  elseif level == 2 then
    ...
    -- insane
    ParseWaveString(list, "0304,0424,0504,0624,0244,0414,0703,0353,0512,0433,0352,0622,0244,0643,0514,0634,0813,0802,1202,0493,1023,0813,1033,0644,0574,0683,1002,0563,1224,0574,1603,1043,1213,0663,0573,0693,2002,1543,0852,0583,0802,1002,1022,1522,1042,1412,1602,0852,1512,1632,1652,1522,1042,0642,1012,1832,1812,1601,2051,0991,2071,1081")
  end
