...
function CreatePredefinedWaveList(level)
  ...
  if level == 0 then
    -- easy
    ParseWaveString(list, "0208,0408,0328,0148,0528,0318,0608,0518,0338,0258,1206,0396,1026,0576,0686,1006,0816,0808,1206,0398,1026,0578,0688,1504,0816,0666,2074")
  elseif level == 1 then
    -- medium
  ...
  elseif level == 2 then
    ...
    -- insane
    ParseWaveString(list, "0304,0504,0424,0624,0244,0414,0703,0353,0512,0433,0352,0622,0244,0643,0514,0634,0813,0802,1202,0493,1023,0813,1033,0644,0574,0683,1002,0563,1224,0574,1603,1043,1213,0663,0573,0693,2002,1543,0853,0583,0802,1002,1022,1522,1042,1412,1602,0852,1512,1632,1652,1522,1042,0642,1012,1832,1812,1601,2001,0991,2021,1081")
  end
