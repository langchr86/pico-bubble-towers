...
function CreatePredefinedWaveList(level)
  ...
  elseif level == 1 then
    ...
    -- hard
    ParseWaveString(list, "0204,0404,0324,0144,0524,0314,0604,0514,0334,0254,0256,0524,0246,0446,0514,0434,0614,0804,1204,0394,1026,0578,0688,1006,0814,1036,0644,0664,1224,0874,1604,1046,1214,2006,1546,1054,1064,1074,1094,1084")
  end
